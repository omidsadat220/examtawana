    ...
    <style>
      ...
      @media (max-width: 1200px) {
            .auth-card {
             ...
             #container_login {
                background-size: 100% 100%;
                background-image: url("{{ asset('assets/img/small-bg.png') }}") !important;
                background-repeat: no-repeat;
                background-position: center;
...
<body class="min-h-screen auth-container">
    <div class="container" id="container_login">
                ...
                <form method="POST" id="loginPage" class="page mt-5" action="{{ route('login') }}">
                    ...
                    <div class="flex items-center justify-between mb-5">
                       ...
                       <a href="/auth/google" class="btn" 
                           style=" color:rgb(34, 197, 94); display:inline-flex; align-items:center; gap:8px;">
                            ...
                            <svg width="18" height="18" viewBox="0 0 48 48">
                                <path fill="#EA4335" d="M24 9.5c3.2 0 5.4 1.4 6.6 2.6l4.8-4.8C32.4 4.4 28.6 2.5 24 2.5 14.9 2.5 7.3 8.9 4.7 17.5l5.6 4.3C11.8 14.8 17.4 9.5 24 9.5z"/>
                                <path fill="#4285F4" d="M46.5 24.5c0-1.6-.1-2.8-.4-4.1H24v7.8h12.7c-.3 2-1.6 5-4.7 7l5.8 4.5c3.4-3.1 5.7-7.7 5.7-15.2z"/>
                                <path fill="#FBBC05" d="M10.3 28.2c-.4-1.2-.6-2.5-.6-3.7s.2-2.5.6-3.7l-5.6-4.3C3.6 18.8 3 21.4 3 24.5s.6 5.7 1.7 8l5.6-4.3z"/>
                                <path fill="#34A853" d="M24 46.5c4.6 0 8.4-1.5 11.2-4.1l-5.8-4.5c-1.5 1-3.6 1.7-5.4 1.7-6.6 0-12.2-5.3-13.7-12.3l-5.6 4.3C7.3 40.1 14.9 46.5 24 46.5z"/>
                            </svg>
                        </a>
        ...
        <!-- social media -->
        <div class="wrapper">
            <a href="https://www.facebook.com/share/1D2niYE6Mh/?mibextid=LQQJ4d" class="button">
                <div class="icon">
                    <i class="fab fa-facebook-f"></i>
                </div>
                <span>Facebook</span>
            </a>
            <a href="https://www.instagram.com/tawana_technology?igsh=MXR2cnM2NTZyd2xtYQ==" class="button">
                <div class="icon">
            ...
            <a href="https://www.youtube.com/@Tawana_Technology_ECDI" class="button">
                <div class="icon">
